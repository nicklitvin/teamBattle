...
export default class MyMath {
     ...
     * @param speed 
     */
     static move(from , to , speed , time = 1)  {
     ...
     * @returns 
     */
     static extendToMaxRange(from , to ,
         speed , time )  
    {
        let xDiff = to.x - from.x;
        let yDiff = to.y - from.y;
     ...
     */
     static doCirclesIntersect(c1 , c2 )  {
     ...
     */
     static getDistanceBetween(c1 , c2 )  {
